...
package vn.edu.iuh.fit.chatservice.config.videocall.one2One;
 ...
 * @since 4.3.1
 */
public class One2OneCallHandler extends TextWebSocketHandler {

  private static final Logger log = LoggerFactory.getLogger(One2OneCallHandler.class);
  ...
  @Autowired
  private One2OneUserRegistry registry;
